...
if ($_POST) {
  ...
  $sentence = $conexion->prepare("insert into mantenimientos (id,id_tecnico,id_computador,tipo_mantenimiento,caso,precio) 
  values 
  (null,:id_tecnico,:id_computador,:tipo_mantenimiento,:caso,:precio)");
